  ...
  <div>
      ...
      <el-col :span="24">
        <div class="grid-content bg-purple-dark">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item :to="liveClassUrl">直播课时</el-breadcrumb-item>
            <el-breadcrumb-item>编辑直播课时</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </el-col>
    </el-row>
    ...
    <div class="search">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
        ...
        <el-form-item>
          <el-button type="primary" size="small" @click="saveEditInformation">保存</el-button>
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      this.liveClassUrl = {
        path: `/liveManagement/liveClass/` + window.localStorage.getItem('paramsId')
      };
      const loading = promptUtil.loading(this);
      getSaveCreateClassInformation(qs.stringify({
        ...
        loading.close();
        promptUtil.LOG('getSaveCreateClassInformation-err',error);
      })
    ...
    methods: {
      saveEditInformation() {
        ...
        // console.log('this.ruleForm.liveShelUnderTime', this.ruleForm.liveShelUnderTime)
        const moment = require("moment");
        const loading = promptUtil.loading(this);
        editSaveCreateClassInformation(qs.stringify({
          course_id: this.$route.params.id,
          ...
          if (res.code == SUCCESS_CODE) {
            if (res.data && res.data!='[]') {
              ...
              this.$router.push({path: `/liveManagement/liveClass/` + window.localStorage.getItem('paramsId')})
            }
          ...
          loading.close();
          promptUtil.LOG('editSaveCreateClassInformation-err',error);
        })
      ...
      resetSearchRuleForm(formeName) {
        this.$refs[formeName].resetFields();
      }
    }
  }
</script>
