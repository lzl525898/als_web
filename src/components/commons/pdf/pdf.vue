<template>
  <div class="pdfContent">
    <el-button type="primary" class="icon-add" icon="el-icon-plus" @click="iconAdd"></el-button>
    <el-button type="primary" class="icon-jian" icon="el-icon-minus" @click="iconJian"></el-button>
